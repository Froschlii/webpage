...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send(
      ...
      setCurrentAnimation('idle');
      console.log(error);
      showAlert({ show: true, text: 'something went wrong, please try again, bud.', type: 'danger'})
    })
  };
      ...
      <div className="flex-1 min-w-[50%] flex flex-col">
        ...
        >
          ...
          <label className="text-black-500 font-semibold">
            ...
            name="email"
            className="input" 
            placeholder="nils.paweldyk@gmail.com" 
            required 
            value={form.email}
            onChange={handleChange}
            onFocus={handleFocus}
          ...
          <label className="text-black-500 font-semibold">
            ...
            rows={4}
            className="textarea" 
            placeholder="Lass mich wissen, wie ich dir weiterhelfen kann!" 
            required 
            value={form.message}
            onChange={handleChange}
            onFocus={handleFocus}
...
//TODO: "Contacts" link oben in der Mitte!